...
public class RefreshScrollingUtil
{
    ...
    public static boolean isScrollToTop(View view)
    {
        ...
        {
            return isScrollViewOrWebViewToTop(view);
        ...
        {
            throw new RuntimeException("不支持判断该控件是否滑动到顶部");
        }
        ...
        if (recyclerView != null)
        {
            ...
            if (manager instanceof LinearLayoutManager)
            {
                ...
                if (recyclerView.getChildCount() > 0)
                {
                    ...
                    if (firstVisibleChild != null && firstVisibleChild.getMeasuredHeight() >= recyclerView
                            .getMeasuredHeight())
                    {
                    ...
                    firstChildTop = firstChild.getTop() - layoutParams.topMargin - getRecyclerViewItemTopInset
							(layoutParams) - recyclerView.getPaddingTop();
                }
